...
fun task10(): List<Int> {
    ...
    Collections.sort(arrayList, object: Comparator<Int> {
        override fun compare(o1: Int?, o2: Int?): Int {
            return if (o2 != null) o2.compareTo(o1 ?: 0) else (o1 ?: 0)  
        }
    })

    // Can also more simply done with lambdas
    // Collections.sort(arrayList) { o1, o2 -> if (o2 != null) o2.compareTo(o1 ?: 0) else (o1 ?: 0) }
